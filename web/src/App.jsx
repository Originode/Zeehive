...
// Row, shortSid, base, the attachXellDevice/detachXellDevice wrappers) went with it; the shared
// ones it also touched (crewLinks, CrewChip, the harness-health words, markXellDone, ZeeTerminal,
// PrCard, LandCard…) are still used by the honeycomb, the wires, the graph and the waiting-on-you
// bar.
