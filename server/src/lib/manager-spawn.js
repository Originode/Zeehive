...
export const DEFAULT_MANAGER_BRIEF = [
  ...
  '',
  '1. Read the repo manual — CLAUDE.md or AGENTS.md first, then README.md — so you know what this',
  '   project is and how it is worked on. A HANDOFF/handover doc is history written for a host',
  '   session, not a manual: read it for rationale, take current facts from the code.',
